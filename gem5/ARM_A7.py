...
class ARM_A7_L1D_Cache(Cache):
    ...
    def __init__(self, options=None):
        super(ARM_A7_L1D_Cache, self).__init__()
        pass
...
class ARM_A7_L1I_Cache(Cache):
    ...
    def __init__(self, options=None):
        super(ARM_A7_L1I_Cache, self).__init__()
        pass
...
############################################################
        self.cpu.icache  = ARM_A7_L1I_Cache()
        self.cpu.dcache  = ARM_A7_L1D_Cache()
